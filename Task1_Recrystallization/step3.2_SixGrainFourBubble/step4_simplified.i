...
## mpirun -n 4 /home/yp/projects/recrystallization/recrystallization-opt -i step4_simplified.i
################################################################################
...
[Executioner]
  ...
  [./TimeStepper]
    ...
    timestep_limiting_function = 1.0e-14
  [../]
  nl_rel_tol      = 1e-7
  nl_abs_tol      = 1e-9
  nl_max_its      = 25
