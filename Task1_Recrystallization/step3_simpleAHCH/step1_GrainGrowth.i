...
[Mesh]
  ...
  [AuxKernels]
    [./local_free_energy]
      ...
      kappa_names        = 'kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta'
      additional_free_energy = cross_energy
    [../]
    [./cross_terms]
      type               = CrossTermGradientFreeEnergy
      variable           = cross_energy #η1…η6的梯度项
      interfacial_vars   = 'eta1 eta2 eta3 eta4 eta5 eta6'
      # 10×10 个项，全部用同一个 kappa_eta
      kappa_names        = 'kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta
                            kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta
                            kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta
                            kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta
                            kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta
                            kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta kappa_eta'
  ...
  [Materials]
    ...
    [./free_energy]
      ...
      property_name    = F
      fi_names         = 'F1 F2 F3 F4 F5 F6'
      hi_names         = 'h1 h2 h3 h4 h5 h6'
      etas             = 'eta1 eta2 eta3 eta4 eta5 eta6'
      W                = 2.0 # 相界面能系数，对应模型中相互作用项
      derivative_order = 2
    [../]
  []
